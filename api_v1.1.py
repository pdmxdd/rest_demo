...
@app.route('/animals/api/v1.1/dogs/', methods=['GET'])
def api_get_dogs():
    """
    Request handler for GET /animals/api/v1.1/dogs
...
@app.route('/animals/api/v1.1/dogs/<int:dog_id>', methods=['GET'])
def api_get_dog_by_id(dog_id):
    """
    Request handler for GET /animals/api/v1.1/dogs/<id>
...
@app.route('/animals/api/v1.1/dogs/', methods=["POST"])
def api_post_new_dog():
    """
    Request handler for POST /animals/api/v1.1/dogs ---
...
@app.route('/animals/api/v1.1/dogs/<int:dog_id>', methods=['PUT'])
def update_dog(dog_id):
    """
    Request handler for PUT /animals/api/v1.1/dogs/<id> --- REQUEST must contain json updating either dog name, or age
...
@app.route('/animals/api/v1.1/dogs/<int:dog_id>', methods=['DELETE'])
def delete_dog(dog_id):
    """
    Request handler for DELETE /animals/api/v1.1/dogs/<id>
